...
**Tech Stack:** React 19, react-grid-layout, @tanstack/react-query, axios (api.js), Hodo design system (A tokens, I icons, Card/KPI/KV/Stat primitifleri), better-sqlite3 (mevcut getDb() pattern)
